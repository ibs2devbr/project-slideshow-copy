<?php
    ...
    //     return [
    //         '<div', ...setClass ([ 'd-flex', 'flex-column', 'flex-lg-row', 'h-100', 'w-100', setFileName ([ $is_set, 'container' ]) ]), '>',
    //             '<div', ...setClass ([ 'col-12', 'col-lg-9', 'd-flex', 'h-lg-320', 'h-100', 'position-relative', setFileName ([ $is_set, 'wrapper' ]) ]), '>',
